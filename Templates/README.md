...
### 1. `handoff.md`
**Core template for session handoffs**
...
### 2. `prompt.md`
**Core template for reusable prompts**
...
### 3. `task.md`
**Core template for task tracking**
...
### 4. `session-plan.md`
**Session management template (auto-created by /obsd_* commands)**
...
**Session management template (auto-created by /obsd_close_session)**
...
**Session management template (used with /compact command)**
...
**Created:** 2025-11-06
**Last Updated:** 2025-11-11 (cleaned up, removed web-ui templates)